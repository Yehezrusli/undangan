        ...
        <div class='cover'>
            ...
            <div class="row" style='margin-top: 10px'>
                <div class="col">
                    <span>
                        <center>
                            <p class='placetime' style='font-size: 18px'>Due to this pandemic situation, <br> we need to register every guest that will come to our Matrimony <br> to maintain health protocols. </p> 
