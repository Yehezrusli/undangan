        ...
        <div class='cover'>
                ...
                <nav class="navbar navbar-light navbar-expand-md justify-content-md-center justify-content-start ">
                    ...
                    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                        <ul class="navbar-nav mx-auto text-md-center text-left">
                            ...
                            <li class="nav-item">
                                <a class="nav-link ms-4 active" href="photo.php">Photo</a> 
                            </li>
                        </ul>
                    </div>
                </nav>
            ...
            <div class="row" style='margin:10px'>
                <div class="col-lg-4 col-md-12 mb-4 mb-lg-0">
                    <img
                    src="images/L1008727.jpg"
                    class="w-100 shadow-1-strong rounded mb-4"
                    alt=""
                    />

                    <img
                    src="images/L1008947.jpg"
                    class="w-100 shadow-1-strong rounded mb-4"
                    alt=""
                    />
                </div>
                ...
                <div class="col-lg-4 mb-4 mb-lg-0">
                    <img
                    src="images/L1009123.jpg"
                    class="w-100 shadow-1-strong rounded mb-4"
                    alt=""
                    />

                    <img
                    src="images/L1009036.jpg"
                    class="w-100 shadow-1-strong rounded mb-4"
                    alt=""
                    />
                </div>
                ...
                <div class="col-lg-4 mb-4 mb-lg-0">
                    <img
                    src="images/L1008844.jpg"
                    class="w-100 shadow-1-strong rounded mb-4"
                    alt=""
                    />

                    <img
                    src="images/L1008884.jpg"
                    class="w-100 shadow-1-strong rounded mb-4"
                    alt=""
                    />
                </div>
